...
namespace Servicio_Update.Models
{
    public partial class DbLoginWsJwtContext : DbContext
    {
        ...
        public virtual DbSet<Class_Habitaciones> habitaciones { get; set; }
        public virtual DbSet<Class_Ocupaciones> ocupaciones { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.habitacion_ID).HasName("PK_Habitaciones");
                entity.ToTable("Habitaciones");
            });

            modelBuilder.Entity<Class_Ocupaciones>(entity =>
            {
                entity.HasKey(e => e.ocupacion_ID).HasName("PK_Ocupaciones");
